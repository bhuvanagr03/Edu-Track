...
def assigned_students(request):
    try:
        ...
        assigned_students = Students.objects.filter(proctor_id=staff)

        if not assigned_students.exists():
            messages.info(request, "No students assigned to you as a proctor.")

        context = {
            "assigned_students": assigned_students
        }

        return render(request, "staff_template/assigned_students.html", context)
